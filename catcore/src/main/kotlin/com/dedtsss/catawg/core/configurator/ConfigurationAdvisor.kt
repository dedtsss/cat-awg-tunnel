...
object AwgParameterExplanationCatalog {
    ...
    val all =
        listOf(
            ...
            item(
                "I1",
                "Сигнатурный пакет I1",
                "Первый необязательный AWG2 пакет перед handshake.",
            ...
            item(
                "I2",
                "Сигнатурный пакет I2",
                "Второй необязательный AWG2 пакет перед handshake.",
                up = "Больше/длиннее увеличивает служебный трафик.",
                down = "Меньше/короче уменьшает служебный трафик.",
                risks =
                    "Слишком большой пакет может фрагментироваться; данные должны поддерживаться backend.",
            ...
            item(
                "I3",
                "Сигнатурный пакет I3",
                "Третий необязательный AWG2 пакет перед handshake.",
                up = "Больше/длиннее увеличивает служебный трафик.",
                down = "Меньше/короче уменьшает служебный трафик.",
                risks =
                    "Слишком большой пакет может фрагментироваться; данные должны поддерживаться backend.",
            ...
            item(
                "I4",
                "Сигнатурный пакет I4",
                "Четвёртый необязательный AWG2 пакет перед handshake.",
                up = "Больше/длиннее увеличивает служебный трафик.",
                down = "Меньше/короче уменьшает служебный трафик.",
                risks =
                    "Слишком большой пакет может фрагментироваться; данные должны поддерживаться backend.",
            ...
            item(
                "I5",
                "Сигнатурный пакет I5",
                "Пятый необязательный AWG2 пакет перед handshake.",
                up = "Больше/длиннее увеличивает служебный трафик.",
                down = "Меньше/короче уменьшает служебный трафик.",
                risks =
                    "Слишком большой пакет может фрагментироваться; данные должны поддерживаться backend.",
